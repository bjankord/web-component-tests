System.register(['./index-abf50da2.system.js'], function (exports, module) {
    'use strict';
        ...
        execute: function () {
            ...
            var patchEsm = exports('a', function () {
                ...
                if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
                    // @ts-ignore
                    return module.import(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-2ee9068f.system.js').then(function () {
            ...
            var patchBrowser = exports('p', function () {
                ...
                if (!BUILD.safari10 && importMeta !== '') {
                    ...
                    if (BUILD.dynamicImportShim && !win.customElements) {
                        ...
                        // @ts-ignore
                        return module.import(/* webpackChunkName: "polyfills-dom" */ './dom-60f7a085.system.js').then(function () { return opts; });
                    }
                }
